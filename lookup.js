...
function sizeshards() {
    $(".wrap").each(function () {
        var t = .99 * $(window).width(), a = .7 * t, e = -1 * (t / 2), n = -1 * (a / 2) - 0;
        $(this).each(function () {
            $(this).css({width: t, height: a, "margin-top": n, "margin-left": e})
        })
...
newAnimal = 0;
var prevAnimal = 0, skipped = 0, forcelinesshift = 50, resizingPublicVariable = 1;
$(document).ready(function () {
    ...
    if ($(".touch").length) ; else if ($(".preloader-layer-2").length || $(".all-animals").length) {
    ...
    onSoundManagerReady: function () {
        soundManager.createSound({
            ...
            id: "hover", url: "audio/hover_ui.mp3", autoLoad: !0, onload: function () {
            }
        }), soundManager.createSound({
            id: "softhover", url: "audio/hover_ui.mp3", autoLoad: !0, onload: function () {
                this.setVolume(50)
            }
        }), soundManager.createSound({
            id: "smashpiano", url: "audio/smash.mp3", autoLoad: !0, onload: function () {
                this.setVolume(30)
            }
        })
    },
